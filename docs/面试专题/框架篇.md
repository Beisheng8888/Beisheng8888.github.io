...
![img](img/image-20210903085238916.png)
...
![img](img/image-20210903085454603.png)

* 构造方法的循环依赖如图所示，显然无法用前面的方法解决

![img](img/image-20210903085906315.png)
...
public class App60_3 {
    ...
    public static void main(String[] args) {
        ...
        scanner.scan("com.beisheng.app60.sub");
        context.refresh();
        System.out.println();
    }
}
...
![img](img/image-20210903100752165.png)
...
![img](img/image-20210903100914140.png)
...
![img](img/image-20210903101849924.png)
...
![img](img/image-20210903103030877.png)
...
![img](img/image-20210903120436365.png)
...
![img](img/image-20210903140657163.png)
...
![img](img/image-20210903141017502.png)

3. 将 HandlerMethod 连同匹配到的拦截器，生成调用链对象 HandlerExecutionChain 返回

![img](img/image-20210903141124911.png)

4. 遍历HandlerAdapter 处理器适配器，找到能处理 HandlerMethod 的适配器对象，开始调用

![img](img/image-20210903141204799.png)

**调用阶段**

1. 执行拦截器 preHandle

![img](img/image-20210903141445870.png)
...
![img](img/image-20210903141658199.png)
...
![img](img/image-20210903141749830.png)

4. 第 2 步有异常，进入 HandlerExceptionResolver 异常处理流程

![img](img/image-20210903141844185.png)
