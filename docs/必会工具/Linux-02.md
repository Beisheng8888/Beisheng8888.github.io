...
上述我们介绍了Linux系统软件安装的四种形式，接下来我们就通过第一种(二进制发布包)形式来安装JDK。 JDK对应的二进制发布包，在资料中已经提供，如下：![image-20210814174022881](assets/image-20210814174022881.png)
...
在资料中，提供的有MySQL的安装包 ，我们需要将该安装包上传到Linux系统的根目录 / 下面。
...
>
> ​		![img](assets/image-20210816193941094.png )
>
...
![img](assets/image-20210815145550077.png )
...
>
>
> 对于Shell脚本编写不作为本重点内容，直接使用资料中提供的脚本文件bootStart.sh即可。
