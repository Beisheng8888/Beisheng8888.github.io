...
```json
POST /beisheng/_update/1
{
  "doc": {
    "email": "ZhaoYun@beisheng.cn"
  }
}
```
...
在hotel-demo的cn.beisheng.hotel.constants包下，创建一个类，定义mapping映射的JSON字符串常量：

```java
package cn.beisheng.hotel.constants;
...
import cn.beisheng.hotel.pojo.Hotel;
